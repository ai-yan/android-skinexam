...
//        findViewById(R.id.btnSend).setOnClickListener(this);
    ...
    private void Chk_online() {
        ...
        if (Methods.isOnline(this)) {
            ...
            if (eMail.equals("")){
                Toast.makeText(ForgetPasswordActivity.this, R.string.input_email, Toast.LENGTH_SHORT).show();
            }else {
                if (Validation.isValidEmail(eMail)){
                    Methods.showProgress(this);
                    sendEmail();
                }else {
                    Toast.makeText(ForgetPasswordActivity.this, R.string.input_valid_email, Toast.LENGTH_SHORT).show();
                }
            }
        } else {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error.networkResponse == null) {
                    if (error.getClass().equals(TimeoutError.class)) {
                        Toast.makeText(ForgetPasswordActivity.this, R.string.timeout_error, Toast.LENGTH_LONG).show();
                    }
                }
            }
        }) {
