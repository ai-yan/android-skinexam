...
package com.skinexam.myapplication.ui.subscription.util;
...
public class IabHelper {
    ...
    public void launchPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener mPurchaseListener)
        throws IabAsyncInProgressException {
        launchPurchaseFlow(act, sku, requestCode, mPurchaseListener, "");
    }

    public void launchPurchaseFlow(Activity act, String sku, int requestCode,
                                   OnIabPurchaseFinishedListener mPurchaseListener, String extraData)
        throws IabAsyncInProgressException {
        launchPurchaseFlow(act, sku, ITEM_TYPE_INAPP, null, requestCode, mPurchaseListener, extraData);
    }

    public void launchSubscriptionPurchaseFlow(Activity act, String sku, int requestCode,
                                               OnIabPurchaseFinishedListener mPurchaseListener) throws IabAsyncInProgressException {
        launchSubscriptionPurchaseFlow(act, sku, requestCode, mPurchaseListener, "");
    }

    public void launchSubscriptionPurchaseFlow(Activity act, String sku, int requestCode,
                                               OnIabPurchaseFinishedListener mPurchaseListener, String extraData)
        throws IabAsyncInProgressException {
        launchPurchaseFlow(act, sku, ITEM_TYPE_SUBS, null, requestCode, mPurchaseListener, extraData);
    }
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
        ...
        try {
            ...
            if (oldSkus == null || oldSkus.isEmpty()) {
                ...
                logDebug("Constructing buy intent for " + sku + ", item type: " + itemType + "without sku");
